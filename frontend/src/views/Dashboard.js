...
function Dashboard() {
  ...
  const data = {"listData":[{"date":"03-15T03:00:00","count":100},{"date":"03-15T03:01:00","count":130},{"date":"03-15T03:00:02","count":160},{"date":"03-15T03:03:00","count":190}]}
  ...
  function update (internalId)
  {
    ...
    var url = "http://localhost:5222/loadtest/testRunResult/" + internalId;
        ...
        fetch(url)
          ...
          .then(
            (result) => {
              setInput(result.listData);
              setMaxScale(result.maxValue);
            },
  ...
  // useEffect(() => {
  //     {
  //   fetch("http://localhost:5222/api/test/AggregateResultMock")
  //     .then(res => res.json())
  //     .then(
  //       (result) => {
  //         setInput(result);
  ...
  //     )
  // }
   let inputCount = inputData.map(function(item)
  {
      return item.count;
  });

  let inputDate = inputData.map(function(item)
  {
      return item.label;
  });
  ...
  let test1 = [10,20,30,40,50,69,127,218,229,210];
            ...
            <Card>
              ...
              <Card.Body>
                <div className="ct-chart" id="chartHours">
                  <ChartistGraph
                    data={{ 
                      labels: inputDateObject,
                      series: [inputCountObject],
                      // // series: [
